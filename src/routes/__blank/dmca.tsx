  ...
  return (
    <BlankLayout>
      ...
      >
        ...
        <span style={spanStyle}>
          , the "<b>DMCA</b>"). The address of Y Combinator's Designated Agent
      ...
      <p class="MsoNormal" style={paragraphStyle2}>
        <span style={spanStyle}>
          ...
          notice (by fax or regular mail) to the Designated Agent at the address
          below.{" "}
          <b>
          ...
          infringing your copyright(s). Please use the following format
      ...
      <ol style={{ marginTop: "0in" }} start={1} type="1">
        ...
        <li class="MsoNormal" style={liStyle}>
          <span style={liSpanStyle}>
            ...
            either the copyright owner, or authorized to make the complaint on
      ...
      <p class="MsoNormal" style={paragraphStyle2}>
        <span style={spanStyle}>
          ...
          material that it has removed or disabled access to the material. Y
          Combinator reserves the right, in its sole discretion, to immediately
          terminate the account of any Subscriber who is the subject of repeated
          DMCA notifications.
        </span>
      </p>
      <p class="MsoNormal" style={paragraphStyle}>
      ...
      <ul style={{ listStyleType: "disc", marginTop: "0in" }}>
        ...
        <li class="MsoNormal" style={liStyle}>
          <span style={liSpanStyle}>
            ...
            the federal district courts located in San Francisco, CA if your
            address is outside of the United States), and that you will accept
      ...
      <p class="MsoNormal" style={paragraphStyle2}>
        <span style={spanStyle}>
          ...
          notification. The original Notifying Party (or the copyright holder he
          or she represents) will then have ten (10) days to notify us that he
          or she has filed legal action relating to the allegedly infringing
          material. If Y Combinator does not receive any such notification
