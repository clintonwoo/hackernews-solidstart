...
export function NewsWelcomePage(): JSX.Element {
  return (
    <NoticeLayout>
      ...
      <br />
      <p>
        <Link to="/">Hacker News</Link> is a bit different from other community
        sites, and we&#39;d appreciate it if you&#39;d take a minute to read the
        following as well as the{" "}
        <Link to="/newsguidelines">official guidelines</Link>.
      </p>
      <p>
      ...
      <p>
        ...
        HN don&#39;t have to be about hacking, because good hackers aren&#39;t
        only interested in hacking, but they do have to be deeply interesting.
      </p>
      <p>
        What does &quot;deeply interesting&quot; mean? It means stuff that
        teaches you about the world. A story about a robbery, for example, would
        probably not be deeply interesting. But if this robbery was a sign of
        some bigger, underlying trend, perhaps it could be.
      </p>
      <p>
        ...
        <a href="http://en.wikipedia.org/wiki/Nile_perch">
          that sort of thing onto a news site, it will push aside the deeply
      ...
      <p>
        ...
        consideration that hadn&#39;t previously been mentioned, and by giving
        more information about the topic, perhaps from personal experience.
        Whereas comments like &quot;LOL!&quot; or worse still, &quot;That&#39;s
      ...
      <p>
        ...
        especially discourage are comments that are empty and negative—comments
      ...
      <p>
        ...
        people into being much ruder than they&#39;d be in person. So the
        principle here is: don&#39;t say anything you wouldn&#39;t say face to
        face. This doesn&#39;t mean you can&#39;t disagree. But disagree without
        calling names. If you&#39;re right, your argument will be more
