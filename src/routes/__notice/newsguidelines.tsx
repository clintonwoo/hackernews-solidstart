  ...
  return (
    <NoticeLayout>
      ...
      <p>
        ...
        cute animal pictures. If they&#39;d cover it on TV news, it&#39;s
        probably off-topic.
      </p>
      <p>
        <b>In Submissions</b>
      ...
      <p>
        ...
        uppercase or exclamation points, or adding a parenthetical remark saying
        how great an article is. It&#39;s implicit in submitting something that
      ...
      <p>
        ...
        &quot;10 Ways To Do X&quot; to &quot;How To Do X,&quot; and &quot;14
      ...
      <p>
        ...
        send it to hn@ycombinator.com. Similarly, please don&#39;t use HN posts
        to ask YC-funded companies questions that you could ask by emailing
        them.
      </p>
      <p>
      ...
      <p>
        ...
        Don&#39;t be snarky. Comments should get more civil and substantive, not
      ...
      <p>
        ...
        replying; <Link to="/newsfaq#cflag">flag</Link> them instead. When you
      ...
      <p>
        ...
        don&#39;t create them routinely. On HN, users need an identity that
