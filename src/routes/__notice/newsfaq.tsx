  ...
  return (
    <NoticeLayout>
      ...
      <p>
        ...
        was submitted. Comments in comment threads are ranked the same way.
      </p>
      <p>
      ...
      <p>
        ...
        number of downvotes. The numbers don&#39;t match up exactly, because
        some votes aren&#39;t counted to prevent abuse.
      </p>
      <p>
      ...
      <p>
        <Link to="/formatdoc">http://news.ycombinator.com/formatdoc</Link>
      </p>
      <p>
      ...
      <p>
        ...
        want to submit a link with comments, just submit it, then add a regular
        comment.
      </p>
      <p>
      ...
      <p>
        No. Users should vote for a story because it&#39;s intellectually
        interesting, not because someone is promoting it.
      </p>
      <p>
      ...
      <p>Please do not post job ads as story submissions to HN.</p>
      <p>
        A regular &quot;Who Is Hiring?&quot; thread appears on the first weekday
        of each month. Most job ads are welcome there. (But only an account
        called <Link to="/submitted?id=whoishiring">whoishiring</Link> is
        allowed to submit the thread itself. This prevents a race to post it
        first.)
      </p>
      <p>
      ...
      <p>
        ...
        been killed by HN&#39;s software, moderators, and user flags.
      </p>
      <p>
      ...
      <p>
        ...
        for maxvisit minutes at a time, with gaps of minaway minutes in between.
        The defaults are 20 and 180, which would let you view the site for 20
        minutes at a time, and then not allow you back in for 3 hours. You can
        override noprocrast if you want, in which case your visit clock starts
        over at zero.
      </p>
      <p>
      ...
      <p>
        <Link to="/newpoll">http://news.ycombinator.com/newpoll</Link>
      </p>
      <p>
        <b>How do I reset my password?</b>
      </p>
      <p>
        If you have an email address in your profile, you can request a password
        reset <Link to="/forgot?id=">here</Link>. If you haven&#39;t, you can
        create a new account or email hn@ycombinator.com for help.
      </p>
      <p>
      ...
      <p>
        ...
        The <Link to="/item?id=4761102">self-serve unbanning procedure</Link>{" "}
